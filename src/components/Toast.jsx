...
const Settings = () => {
   ...
   const [toast, setToast] = useState(null); // Add state for toast
   ...
   // Add function to add 500k points
   const add500kPoints = () => {
      const data = loadUserData();
      data.points = (data.points || 0) + 500000;
      saveUserData(data);
      setToast({ message: 'Successfully added 500k points!', type: 'success' });
      debugLog('Added 500k points');
   };
